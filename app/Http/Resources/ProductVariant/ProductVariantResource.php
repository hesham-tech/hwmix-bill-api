...
class ProductVariantResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'image' => $this->image ? parse_url($this->image->url, PHP_URL_PATH) : null,
            'primary_image_url' => $this->image ? parse_url($this->image->url, PHP_URL_PATH) : ($this->product && $this->product->image ? parse_url($this->product->image->url, PHP_URL_PATH) : null),
            'weight' => $this->weight,
