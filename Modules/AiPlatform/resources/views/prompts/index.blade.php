...
<head>
    ...
    <title>قوالب الـ Prompts - AI Platform</title>
    ...
    <div class="row">
        <div class="col-md-2 sidebar p-3">
            ...
            <nav class="nav flex-column">
                ...
                <a class="nav-link active" href="{{ route('ai-platform.prompts.index') }}"><i class="fa-solid fa-terminal me-2"></i> قوالب الـ Prompts</a>
                <a class="nav-link" href="{{ route('ai-platform.usage.index') }}"><i class="fa-solid fa-coins me-2"></i> الاستهلاك والتكاليف</a>
            </nav>
        </div>
        <div class="col-md-10 p-4">
            <h2><i class="fa-solid fa-terminal text-info me-2"></i> سجل وقوالب الـ Prompts (Zero Hardcoded Prompts)</h2>
            <div class="card card-custom p-3 mt-4">
                <table class="table table-dark table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td><code>product.description.generate</code></td>
                            <td>قالب توليد وصف المنتجات التسويقي</td>
                            <td><span class="badge bg-primary">text.generate</span></td>
                            <td><span class="badge bg-info">v1</span></td>
