...
<head>
    ...
    <title>إدارة الوكلاء الذكيين - AI Platform</title>
    ...
    <div class="row">
        <div class="col-md-2 sidebar p-3">
            ...
            <nav class="nav flex-column">
                ...
                <a class="nav-link active" href="{{ route('ai-platform.agents.index') }}"><i class="fa-solid fa-user-astronaut me-2"></i> الوكلاء (Agents)</a>
        ...
        <div class="col-md-10 p-4">
            <h2><i class="fa-solid fa-user-astronaut text-warning me-2"></i> الوكلاء الذكيون (Agents)</h2>
            <div class="card card-custom p-3 mt-4">
                <p class="text-muted">جميع الوكلاء مُدارون بالكامل من قاعدة البيانات وتدعم الذاكرة والـ RAG والأدوات.</p>
                <div class="alert alert-info bg-dark border-secondary text-light">
                    <i class="fa-solid fa-info-circle text-info me-2"></i> يمكنك إنشاء وتعديل الوكلاء وربطهم بالسياسات والأدوات المتاحة مباشرة من قاعدة البيانات أو عبر لوحة التحكم.
                </div>
            </div>
        </div>
    </div>
