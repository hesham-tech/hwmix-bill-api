...
class AgentDeviceController extends Controller
{
    ...
    {
        $versionCode = 8; // رقم إصدار الـ APK المتوفر حالياً على السيرفر
        $versionName = "1.0.7";
        ...
        return api_success([
            ...
            'changelog' => 'طلب الصلاحيات تلقائياً، وإضافة شاشة إقلاع ترحيبية، وتعديل الرابط الافتراضي للباك إند.',
            'force_update' => true
