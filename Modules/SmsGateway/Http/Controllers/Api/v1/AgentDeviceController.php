...
class AgentDeviceController extends Controller
{
    ...
    {
        $versionCode = 9; // رقم إصدار الـ APK المتوفر حالياً على السيرفر
        $versionName = "1.0.8";
        ...
        return api_success([
            ...
            'changelog' => 'معالجة مشكلة تثبيت التطبيق بإرجاع التوقيع التلقائي الافتراضي، وإضافة الشعار والأيقونة.',
            'force_update' => true
