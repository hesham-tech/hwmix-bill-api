...
class ProductData
{
    public function __construct(
        ...
        public bool $is_active_in_store = false,
        public bool $is_active_in_sales = false,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            is_active_in_store: isset($data['is_active_in_store']) ? (bool) $data['is_active_in_store'] : false,
            is_active_in_sales: isset($data['is_active_in_sales']) ? (bool) $data['is_active_in_sales'] : false,
            desc: $data['desc'] ?? null,
    ...
    public function toArray(): array
    {
        return array_filter([
            ...
            'is_active_in_store' => $this->is_active_in_store,
            'is_active_in_sales' => $this->is_active_in_sales,
            'desc' => $this->desc,
